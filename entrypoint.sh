...
monero-wallet-rpc --testnet --trusted-daemon --wallet-file /monero/wallets/testwallet1 --password "" --log-file /monero/logs/monero-wallet-rpc.testwallet1.log --rpc-bind-port 18081 --disable-rpc-login --rpc-bind-ip 0.0.0.0  --confirm-external-bind
