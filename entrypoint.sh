...
monerod --testnet --no-igd --hide-my-port --data-dir /monero/blockchain/node1 --p2p-bind-ip 127.0.0.1 --log-level 1 --rpc-bind-ip 0.0.0.0  --add-exclusive-node 127.0.0.1:38080 --confirm-external-bind --detach
monerod --testnet --p2p-bind-port 38080 --rpc-bind-port 38081 --no-igd --hide-my-port --data-dir /monero/blockchain/node2 --p2p-bind-ip 127.0.0.1 --log-level 1 --rpc-bind-ip 0.0.0.0 --add-exclusive-node 127.0.0.1:28080 --confirm-external-bind --detach
